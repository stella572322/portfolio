...
export const aboutData = {
  img: imgAbout,
  paragraphOne:
    '過去在一人身兼多職的工作經驗，讓我擁有快速發現問題並解決問題的能力，也促使我想成為 UI / UX 設計師。目前透過書籍、線上課程、競賽，學習 UX/UI 領域的知識，期望透過學習新的知識與技術，分析用戶需求，提高用戶體驗，創造可用性和可行性的產品。我的目標是打造符合使用者需求，並具有商業價值影響力的產品。',
  paragraphTwo:
